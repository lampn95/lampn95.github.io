...
export function StoriesPreview() {
  ...
  return (
    <section className="relative mx-auto max-w-6xl px-5 sm:px-8 py-20">
      <SectionHeading
        eyebrow={t("storiesPreview.eyebrow")}
        title={t("storiesPreview.title")}
        description={t("storiesPreview.description")}
      />
      ...
      <div className="mt-10 text-center">
        ...
        >
          {t("storiesPreview.seeAll")} <ArrowRight className="h-4 w-4" />
        </Link>
      </div>
    </section>
  );
